...
public class TransactionServiceImpl implements TransactionService {
    ...
    public List<Transaction> last10Transactions() {
        return findAllTransactions().stream().filter(transaction -> transaction.getCreateDate() != null)
    ...
    public List<Transaction> findTransactionListById(UUID id) {
        ...
        return findAllTransactions().stream().filter(transaction -> transaction.getSender().equals(id) || transaction.getReceiver().equals(id))
