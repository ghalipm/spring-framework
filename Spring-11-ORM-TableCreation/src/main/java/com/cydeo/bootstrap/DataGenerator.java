...
import com.cydeo.repository.EmployeeRespository;
...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(EmployeeRespository employeeRepository, DepartmentRepository departmentRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        // due to cascading, departmentList, regionsList are not need to be saved: they are saved with the employees
